								...
								<div className="mb-4 pl-4 border-l-4 border-gray-200">
									<div className="flex items-center mb-2">
										<input
											...
											onChange={e =>
												handleLlmConfigChange(provider, 'managedMode.enabled', e.target.checked)
											}
											className="h-4 w-4 rounded border-gray-300 text-blue-600"
										/>
										<label
											htmlFor={`${provider}-managed-enabled`}
								...
								<div className="pl-4 border-l-4 border-gray-200">
									<div className="flex items-center mb-2">
										<input
											...
											onChange={e =>
												handleLlmConfigChange(provider, 'selfManagedMode.enabled', e.target.checked)
											}
											className="h-4 w-4 rounded border-gray-300 text-blue-600"
										/>
										<label
											htmlFor={`${provider}-self-managed-enabled`}
											className="ml-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
										>
											Self-Managed Mode
										</label>
											...
											<div className="flex items-center">
												<input
													...
													onChange={e =>
														handleLlmConfigChange(
															provider,
															'selfManagedMode.requireApiKeyVerification',
															e.target.checked
														)
													}
													className="h-4 w-4 rounded border-gray-300 text-blue-600"
												/>
												<label
													htmlFor={`${provider}-verify-api-key`}
													className="ml-2 block text-sm text-gray-700 dark:text-gray-300"
												>
							...
							<div key={provider} className="border-t pt-6">
								<div className="flex items-center justify-between mb-4">
									...
									<div className="flex items-center">
										<input
											...
											checked={config.enabled}
											onChange={e =>
												handleEmbeddingConfigChange(provider, 'enabled', e.target.checked)
											}
											className="h-4 w-4 rounded border-gray-300 text-blue-600"
										/>
										<label
											htmlFor={`${provider}-emb-enabled`}
											className="ml-2 block text-sm text-gray-700 dark:text-gray-300"
										>
											Enabled
										</label>
								...
								<div className="mb-4 pl-4 border-l-4 border-gray-200">
									<div className="flex items-center mb-2">
										...
										/>
										<label
											htmlFor={`${provider}-emb-managed-enabled`}
											className="ml-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
										>
											Managed Mode
										</label>
								...
								<div className="pl-4 border-l-4 border-gray-200">
									<div className="flex items-center mb-2">
										...
										/>
										<label
											htmlFor={`${provider}-emb-self-managed-enabled`}
											className="ml-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
										>
											Self-Managed Mode
										</label>
									...
									{config.selfManagedMode.enabled && (
										<div className="pl-6 mt-2">
											<div className="flex items-center">
												...
												/>
												<label
													htmlFor={`${provider}-emb-verify-api-key`}
													className="ml-2 block text-sm text-gray-700 dark:text-gray-300"
												>
													Verify API keys on entry
												</label>
