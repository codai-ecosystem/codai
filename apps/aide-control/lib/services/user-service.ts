...
export class UserService {
	 ...
	 */
	public async getUserServiceConfigs(
		userId: string
	): Promise<Record<ServiceType, ServiceConfig[]>> {
		try {
	 ...
	 */
	public async addServiceConfig(userId: string, config: ServiceConfig): Promise<void> {
		try {
