    ...
    <div className={`bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 ${className}`}>
      <div className="p-6 border-b border-gray-200 dark:border-gray-700">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-3">
            <span className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-medium border ${getConnectionColor()}`}>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
          <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-4">
            <div className="flex items-center">
              ...
              <div className="ml-3">
                <p className="text-xs text-blue-600 dark:text-blue-400 font-medium">Total Memories</p>
          ...
          <div className="bg-green-50 dark:bg-green-900/20 rounded-lg p-4">
            <div className="flex items-center">
              ...
              <div className="ml-3">
                <p className="text-xs text-green-600 dark:text-green-400 font-medium">Queries/sec</p>
          ...
          <div className="bg-yellow-50 dark:bg-yellow-900/20 rounded-lg p-4">
            <div className="flex items-center">
              ...
              <div className="ml-3">
                <p className="text-xs text-yellow-600 dark:text-yellow-400 font-medium">Avg Response</p>
          ...
          <div className="bg-purple-50 dark:bg-purple-900/20 rounded-lg p-4">
            <div className="flex items-center">
              ...
              <div className="ml-3">
                <p className="text-xs text-purple-600 dark:text-purple-400 font-medium">Cache Hit Rate</p>
          ...
          <div className="bg-indigo-50 dark:bg-indigo-900/20 rounded-lg p-4">
            <div className="flex items-center">
              ...
              <div className="ml-3">
                <p className="text-xs text-indigo-600 dark:text-indigo-400 font-medium">Vector DB</p>
          ...
          <div className="bg-orange-50 dark:bg-orange-900/20 rounded-lg p-4">
            <div className="flex items-center">
              ...
              <div className="ml-3">
                <p className="text-xs text-orange-600 dark:text-orange-400 font-medium">Agent Connections</p>
