...
function NotificationCard({ notification, onRemove }: NotificationCardProps) {
	...
	const typeStyles = {
		success:
			'bg-green-50 border-l-4 border-green-500 text-green-800 dark:bg-green-900/30 dark:border-green-500 dark:text-green-200',
		error:
			'bg-red-50 border-l-4 border-red-500 text-red-800 dark:bg-red-900/30 dark:border-red-500 dark:text-red-200',
		warning:
			'bg-yellow-50 border-l-4 border-yellow-500 text-yellow-800 dark:bg-yellow-900/30 dark:border-yellow-500 dark:text-yellow-200',
