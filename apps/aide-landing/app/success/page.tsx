	...
	return (
		<div className="min-h-screen bg-gradient-to-br from-background via-background to-primary/5 flex items-center justify-center px-4">
			...
			>
				...
				>
					Your subscription is now active. You can now download AIDE and start building with AI
					superpowers.
				</motion.p>
				...
				{/* Support */}
				<motion.p variants={fadeInUp} className="text-sm text-muted-foreground mt-8">
					Need help getting started?{' '}
					<a href="mailto:support@aide.dev" className="text-primary hover:underline">
