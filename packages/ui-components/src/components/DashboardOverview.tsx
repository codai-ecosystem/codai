...
export function DashboardOverview({
	...
	return (
		<div className={`space-y-6 ${className}`}>
			...
			<div className="flex items-center justify-between">
				<div>
					<h2 className="text-2xl font-bold text-codai-foreground mb-2">Dashboard Overview</h2>
				...
				<div className="flex items-center space-x-3 px-4 py-2 bg-codai-card border border-codai-border/20 rounded-xl">
					<StatusIndicator status={stats.systemStatus} showLabel animate />
				</div>
			</div>
			...
			<div className="bg-codai-card border border-codai-border/20 rounded-2xl p-6">
				<h3 className="text-lg font-semibold text-codai-foreground mb-4">Quick Insights</h3>
				<div className="grid grid-cols-1 md:grid-cols-3 gap-6">
					<div className="text-center">
						<div className="text-2xl font-bold text-green-600 mb-1">98.5%</div>
						<div className="text-sm text-codai-muted-foreground">Uptime this month</div>
					</div>
					<div className="text-center">
						<div className="text-2xl font-bold text-blue-600 mb-1">2.3s</div>
						<div className="text-sm text-codai-muted-foreground">Avg response time</div>
					</div>
					<div className="text-center">
						<div className="text-2xl font-bold text-purple-600 mb-1">4.8/5</div>
						<div className="text-sm text-codai-muted-foreground">User satisfaction</div>
					</div>
				</div>
			</div>
		</div>
