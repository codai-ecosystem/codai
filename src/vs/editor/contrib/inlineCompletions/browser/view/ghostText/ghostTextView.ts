...
export class GhostTextView extends Disposable {
	...
	constructor(
		...
		this.uiState = derived(this, reader => {
			...
			const { inlineTexts, additionalLines, hiddenRange, additionalLinesOriginalSuffix } =
				computeGhostTextViewData(ghostText, textModel, GHOST_TEXT_CLASS_NAME + extraClassNames);
