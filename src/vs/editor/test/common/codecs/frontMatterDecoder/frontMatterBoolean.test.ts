		...
		suite('• non-boolean token', () => {
			...
			suite('• sequence token', () => {
				test('• true', () => {
					...
					const other = new FrontMatterSequence([new Word(new Range(1, 1, 1, 5), booleanText)]);
				...
				test('• false', () => {
					...
					const other = new FrontMatterSequence([new Word(new Range(1, 2, 1, 2 + 6), booleanText)]);
