...
export const MainContext = {
	...
	MainThreadAiSettingsSearch: createProxyIdentifier<MainThreadAiSettingsSearchShape>(
...
export const ExtHostContext = {
	...
	ExtHostAiSettingsSearch:
		createProxyIdentifier<ExtHostAiSettingsSearchShape>('ExtHostAiSettingsSearch'),
