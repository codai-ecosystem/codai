...
export class LanguageModelChatMessage2 implements vscode.LanguageModelChatMessage2 {
	...
	get content2():
		| (string | LanguageModelToolResultPart2 | LanguageModelToolCallPart | LanguageModelDataPart)[]
		| undefined {
...
export class LanguageModelToolResult2 {
	constructor(
		public content: (LanguageModelTextPart | LanguageModelPromptTsxPart | LanguageModelDataPart)[]
	) {}
