...
export namespace ChatContextKeys {
	...
	export const hasPromptFile = new RawContextKey<boolean>('chatPromptFileAttached', false, {
		type: 'boolean',
		description: localize(
	...
	export const Modes = {
		hasCustomChatModes: new RawContextKey<boolean>('chatHasCustomChatModes', false, {
			type: 'boolean',
			description: localize(
