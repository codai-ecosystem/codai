...
export const CTX_INLINE_CHAT_HAS_AGENT2 = new RawContextKey<boolean>(
	...
	false,
	localize('inlineChatHasEditsAgent', 'Whether an agent for inliine for interactive editors exists')
);
...
export const CTX_INLINE_CHAT_REQUEST_IN_PROGRESS = new RawContextKey<boolean>(
	...
	false,
	localize('inlineChatRequestInProgress', 'Whether an inline chat request is currently in progress')
);
