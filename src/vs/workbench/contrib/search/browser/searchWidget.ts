	...
	private renderSearchInput(parent: HTMLElement, options: ISearchWidgetOptions): void {
		...
		const inputOptions: IFindInputOptions = {
			...
			appendWholeWordsLabel: appendKeyBindingLabel(
				'',
				this.keybindingService.lookupKeybinding(Constants.SearchCommandIds.ToggleWholeWordCommandId)
			),
			...
			new ContextScopedReplaceInput(
				...
				this.contextViewService,
				{
					...
					appendPreserveCaseLabel: appendKeyBindingLabel(
						'',
						this.keybindingService.lookupKeybinding(Constants.SearchCommandIds.TogglePreserveCaseId)
					),
